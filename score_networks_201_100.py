...
#python score_networks.py --trainval --augtype none --repeat 1 --score hook_logdet --sigma 0.05
# --nasspace nasbench201 --batch_size 128 --GPU 3 --dataset cifar100 --data_loc ../cifar100/
#python score_networks.py --trainval --augtype none --repeat 1 --score hook_logdet --sigma 0.05
# --nasspace nasbench201 --batch_size 128 --GPU 3 --dataset ImageNet16-120 --data_loc ../imagenet16/Imagenet16/


parser = argparse.ArgumentParser(description='NAS Without Training')
parser.add_argument('--data_loc', default='../cifar100/', type=str, help='dataset folder')
    ...
    try:
        ...
        if 1:
            ...
            if counter % 1000 == 0 and counter > 0:
                ...
                np.save('results/2201_s.npy', scores)
                np.save('results/2201_s_sum.npy', scores_sum)
                np.save('results/2201_s_auv.npy', scores_auc)
                np.save('results/2201_acc.npy', accs)
                if counter == amount:
                    exit()
        else:
            continue
