...
# --nasspace nds_pnas --batch_size 128 --GPU 3
...
parser.add_argument('--nasspace', default='nds_pnas', type=str, help='the nas search space to use')
...
parser.add_argument('--trainval', defult='trainval', action='store_true')
